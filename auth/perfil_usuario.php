                ...
                <div class="card">
                  <div class="card-header card-header-primary">
                    <h4 class="card-title">
                      ...
                      echo $_SESSION['username'] . " Hoje é dia " . date("d/m/Y");}?></p>
                      </h4>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <?php 
                          ...
                          // O usuario poderá apagar, modificar, atualizar ou deletar
                        ?>
                        <td>
                        <?php 
                        ...
                        <td>
                        <?php // trocar posteriormente pra usermail
                          if(isset($_SESSION['username'])) {
                         echo $_SESSION['username'];}?>
                        <a href="?editmail">
                        <i class="material-icons">edit</i>
                        ...
                        <td>
                        <?php 
                         if(isset($_SESSION['withdrawaddr']) ){
                        echo $_SESSION['withdrawaddr']; } 
                        ?>
                      
                        <a href="?editwithdrawaddr">
                        <i class="material-icons">edit</i>
                        </a>
                        </td>
                        <td>
                        ...
                        <a href="user_points.php">

                        <i class="material-icons">info</i>
                        </a>
                        </td>
                        <td> 
                        <?php // Comando para contagem de referências 
                          if(isset($_SESSION['refferals'])){
                            echo $_SESSION['refferals'];
                          }
                         ?>
