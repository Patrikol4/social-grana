...
// Página referente á erros diversos. 
// Onde o usuário reportará os bugs para a equipe de desenvolvimento
?>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 ">
                            <div class="register-card">
                                <h3 class="title">Nós responderemos seu ticket o mais rápido possível!</h3>
                                <form class="register-form" action="verify_login.php" method="post">
                                    <label>Sua reclamação</label>
                                    <input type="text" name="comment" class="form-control" placeholder="">

                                    
                                    <button type="submit" class="btn btn-fill btn-info btn-block">Enviar sugestão</button>
