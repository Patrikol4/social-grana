...
<body>
    <!--Chamando o cabeçalho á pagina atual-->
    <?php 
...
<div class="wrapper">
    <div class="demo-header demo-header-image">
            <div class="motto">
                <h1 class="title-uppercase">Como funciona?</h1>
                <h3>Aprenda de forma explicada a como utilizar nosso site para ganhar dinheiro</h3>
            </div>
    </div>
